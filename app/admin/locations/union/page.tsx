...
import UnionCountyPage from "@/app/locations/union/page"
...
export default function UnionLocationEditor() {
  const { data: session, status } = useSession()
  const router = useRouter()
  const [form, setForm] = useState<UnionForm>(emptyForm)
  ...
  const updateField = (section: keyof UnionForm, field: string, value: any) => {
    setForm(prev => ({
      ...prev,
      [section]: {
        ...prev[section],
      ...
      <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-3xl font-bold text-gray-900">Edit Union County Location</h1>
            <button
